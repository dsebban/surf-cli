...
### Added
- **Gemini headless mode** - Opt-in headless Gemini queries via Bun WebView, bypassing the Chrome extension and native host entirely. Supports `--profile <email>` to use existing Chrome auth.
